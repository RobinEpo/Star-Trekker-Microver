...
# Connexion SSH
host = "192.168.1.42"  # IP de la Pi (à adapter)
username = "pi" 
password = "raspberry"  # Remplacer par le mdp de la PI
...
while True:
    ...
    with sftp.file("/home/pi/input_data.bin", "wb") as f:
        f.write(payload)
